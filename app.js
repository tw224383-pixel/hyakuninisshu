window.addEventListener('error', function(e) {
    ...
    const APP_UPDATES = [
      ...
      },
      {
        version: 'v6.0',
        date: '2026/07/22',
        title: '「今週のヒーロー」リアルタイム自動更新＆レイアウト最適化！',
        details: [
          '今週のヒーロー（レベルアップ王・お手つき最小王）が、全員のプレイ記録から「リアルタイム」で即座に集計・自動更新されるライブ仕様になりました！ページを更新しなくても最新順位へふわりと切り替わります！',
          'スタート画面の「現在の称号（進行状況）」と「AI専属コーチの相性アドバイス」パネルを中央寄せに配置調整し、全体をスッキリ美しく見やすく整列しました！',
          'レベルアップ王（獲得XP部門）の表示単位を「pt」から「XP」表記に変更し、表記の分かりやすさを向上させました。'
        ]
      },
      {
        version: 'v5.2',
