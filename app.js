window.addEventListener('error', function(e) {
    ...
    const APP_UPDATES = [
      ...
      },
      {
        version: 'v4.5',
        date: '2026/07/17',
        title: 'しょうごうの そうび と ゲストモードの ついか',
        details: [
          '<ruby>称号<rt>しょうごう</rt></ruby>（バッジ）を３つまでえらんで、なまえのよこにセットできるようになったよ！',
          'ログインしなくても「ゲストとしてあそぶ」ことができるようになったよ！※ランキングにはさんかできません。',
          'じゅんいひょう（ランキング）のなまえのよこにレベルやそうびしたアイコンがならぶようになったよ！'
        ]
      },
      {
        version: 'v4.2',
        date: '2026/07/16',
        title: 'リタイアボタンとふだのデザインしゅうせい',
        details: [
          'ゲームをとちゅうであきらめてメニューにもどる「リタイア」ボタンをつくったよ！',
          'くらいデザインのふだの文字を「金色の文字（きんのじ）」にして、見やすくかっこよくしたよ！'
        ]
      },
      {
        version: 'v4.0',
        ...
        details: [
          'ミックスモード（いろんな色をまぜるモード）で４０まい・60まい・80まいのコースが選べるようになったよ！',
          'それぞれのコースで１位〜５位にはいると、とくべつなしょうごうがもらえるよ！'
        ]
      }
    ];
    ...
    function updateHeaderUserDisplay() {
      ...
      const savedName = goshikiStorage.getItem('goshiki_current_username') || goshikiStorage.getItem('goshiki_ranking_username') || '';
      if (!savedName) return;
